classdef lib_svm
	...
	methods(Static)
		...
		function [cost, gamma, predict, command] = find_cost_gamma(data, data_classes, parpoolEnable, varargin)
		...
		function cl_res = classify(obj, sample)
			...
			[cl_res_wrk, accuracy, decision_val] = libsvmpredict(label_vector, sample, obj.model, '-b 1'); %#ok<NASGU,ASGLU>
